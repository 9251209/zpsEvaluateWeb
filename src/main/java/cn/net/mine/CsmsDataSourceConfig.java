 ...
 */
@Configuration
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactoryCsms", transactionManagerRef = "transactionManager", basePackages = {"cn.net.mine"})
...
public class CsmsDataSourceConfig {
	...
	public EntityManagerFactory entityManagerFactory(
		...
		lef.setPackagesToScan("cn.net.mine");
