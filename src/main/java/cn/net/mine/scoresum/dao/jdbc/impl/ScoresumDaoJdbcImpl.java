...
public class ScoresumDaoJdbcImpl extends SuperJdbcTemplate implements ScoresumDao {
    ...
    public Object scoresumAdd(String prono, String unitno, String sectionno, String resourcevalue, String energyvalue, String manpowervalue, String totalvalue, String starlevel, String resourcenum, String energynum, String manpowernum,String scorename) {
        ...
        sql.append("INSERT INTO Scoresum(id,prono,unitno,sectionno,resourcevalue,energyvalue,manpowervalue,totalvalue,starlevel,resourcenum,energynum,manpowernum,scorename)");
        sql.append(" VALUES(");
